...
resource "microsoft365_graph_beta_identity_and_access_administrative_unit_role_assignment" "au_user_admin" {
...
resource "microsoft365_graph_beta_identity_and_access_administrative_unit_role_assignment" "au_helpdesk_admin" {
  administrative_unit_id = microsoft365_graph_beta_identity_and_access_administrative_unit.regional_office.id
