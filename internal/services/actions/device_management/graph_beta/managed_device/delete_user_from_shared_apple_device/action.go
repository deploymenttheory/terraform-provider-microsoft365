...
const (
	ActionName = "graph_beta_device_management_managed_device_delete_user_from_shared_apple_device"
)
...
func (a *DeleteUserFromSharedAppleDeviceAction) FullTypeName() string {
