	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"validate_device_exists": schema.BoolAttribute{
				Optional: true,
				MarkdownDescription: "Whether to validate that devices exist and are Shared iPad devices before attempting user deletion. " +
					"Disabling this can speed up planning but may result in runtime errors for non-existent or non-Shared iPad devices. " +
					"Default: `true`.",
			},
