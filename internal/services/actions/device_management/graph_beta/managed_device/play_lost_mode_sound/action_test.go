package graphBetaPlayLostModeSoundManagedDevice_test
...
func TestPlayLostModeSoundAction_Maximal(t *testing.T) {
	mocks.SetupUnitTestEnvironment(t)
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func TestUnitActionPlayLostModeSoundManagedDevice_03_ComanagedOnly(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "comanaged_only" {
  config {
    comanaged_devices = [
      {
...
func TestUnitActionPlayLostModeSoundManagedDevice_04_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "partial_failures" {
  config {
    managed_devices = [
      {
        device_id = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionPlayLostModeSoundManagedDevice_05_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "validation_disabled" {
  config {
    managed_devices = [
      {
        device_id = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionPlayLostModeSoundManagedDevice_06_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "validation_enabled" {
  config {
    managed_devices = [
      {
        device_id = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionPlayLostModeSoundManagedDevice_07_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "invalid_device_id" {
  config {
    managed_devices = [
      {
...
func TestUnitActionPlayLostModeSoundManagedDevice_08_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "no_devices" {
  config {}
}
`,
...
func TestUnitActionPlayLostModeSoundManagedDevice_09_DuplicateDeviceIDs(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "duplicate_device_ids" {
  config {
    managed_devices = [
      {
        device_id = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionPlayLostModeSoundManagedDevice_10_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "multiple_devices" {
  config {
    managed_devices = [
      {
        device_id          = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionPlayLostModeSoundManagedDevice_11_WithDuration(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_play_lost_mode_sound" "with_duration" {
  config {
    managed_devices = [
      {
        device_id          = "00000000-0000-0000-0000-000000000001"
