package graphBetaRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_test
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_03_ComanagedOnly(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "comanaged_only" {
  config {
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_04_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "partial_failures" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_05_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "validation_disabled" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_06_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "validation_enabled" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_07_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "invalid_device_id" {
  config {
    managed_device_ids = [
      "not-a-valid-guid"
    ]
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_08_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "no_devices" {
  config {}
}
`,
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_09_DuplicateDeviceIDs(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "duplicate_device_ids" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001",
      "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionRemoveDeviceFirmwareConfigurationInterfaceManagementManagedDevice_10_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_remove_device_firmware_configuration_interface_management" "multiple_devices" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001",
