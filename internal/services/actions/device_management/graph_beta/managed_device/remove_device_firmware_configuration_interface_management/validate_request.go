...
// DFCIValidationResult contains the results of device validation
type DFCIValidationResult struct {
...
func validateRequest(ctx context.Context, client *msgraphbetasdk.GraphServiceClient, managedDeviceIDs []string, comanagedDeviceIDs []string) (*DFCIValidationResult, error) {
	result := &DFCIValidationResult{
