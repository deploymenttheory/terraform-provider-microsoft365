	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"validate_device_exists": schema.BoolAttribute{
				Optional: true,
				MarkdownDescription: "Whether to validate that devices exist, are iOS/iPadOS devices, and are supervised before attempting to recover passcodes. " +
					"Disabling this can speed up planning but may result in runtime errors for non-existent, unsupported, or unsupervised devices. " +
					"Default: `true`.",
			},
