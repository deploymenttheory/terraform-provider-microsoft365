...
const (
	ActionName = "graph_beta_device_management_managed_device_initiate_on_demand_proactive_remediation"
)
...
func (a *InitiateOnDemandProactiveRemediationManagedDeviceAction) FullTypeName() string {
