...
func (a *GetFileVaultKeyManagedDeviceAction) ValidateConfig(ctx context.Context, req action.ValidateConfigRequest, resp *action.ValidateConfigResponse) {
	...
	resp.Diagnostics.AddWarning(
		"Security Warning: Sensitive Data in Output",
		"This action will retrieve and display FileVault recovery keys in plain text. "+
			"Recovery keys are highly sensitive credentials that grant full access to encrypted device data. "+
			"Ensure proper security controls are in place and that Terraform state is adequately protected. "+
