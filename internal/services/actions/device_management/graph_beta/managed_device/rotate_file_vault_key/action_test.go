package graphBetaRotateFileVaultKeyManagedDevice_test
...
func TestUnitActionRotateFileVaultKeyManagedDevice_03_ComanagedOnly(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "comanaged_only" {
  config {
...
func TestUnitActionRotateFileVaultKeyManagedDevice_04_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "partial_failures" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRotateFileVaultKeyManagedDevice_05_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "validation_disabled" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRotateFileVaultKeyManagedDevice_06_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "validation_enabled" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestUnitActionRotateFileVaultKeyManagedDevice_07_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "invalid_device_id" {
  config {
    managed_device_ids = [
      "not-a-valid-guid"
    ]
...
func TestUnitActionRotateFileVaultKeyManagedDevice_08_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "no_devices" {
  config {}
}
`,
...
func TestUnitActionRotateFileVaultKeyManagedDevice_09_DuplicateDeviceIDs(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "duplicate_device_ids" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001",
      "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionRotateFileVaultKeyManagedDevice_10_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_rotate_file_vault_key" "multiple_devices" {
  config {
    managed_device_ids = [
      "00000000-0000-0000-0000-000000000001",
