	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"validate_device_exists": schema.BoolAttribute{
				Optional: true,
				MarkdownDescription: "Whether to validate that devices exist and are macOS devices before attempting to rotate FileVault keys. " +
					"Disabling this can speed up planning but may result in runtime errors for non-existent or non-macOS devices. " +
					"Default: `true`.",
			},
