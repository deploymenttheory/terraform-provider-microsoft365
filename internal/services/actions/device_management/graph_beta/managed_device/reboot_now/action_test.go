package graphBetaRebootNowManagedDevice_test
...
func TestRebootNowAction_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "partial_failures" {
  config {
    device_ids = [
...
func TestRebootNowAction_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "validation_disabled" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestRebootNowAction_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "validation_enabled" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestRebootNowAction_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "invalid_device_id" {
  config {
    device_ids = [
      "not-a-valid-guid"
    ]
...
func TestRebootNowAction_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "no_devices" {
  config {
    device_ids = []
  }
}
...
func TestRebootNowAction_DuplicateDeviceIDs(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "duplicate_device_ids" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001",
      "00000000-0000-0000-0000-000000000001"
...
func TestRebootNowAction_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "multiple_devices" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001",
...
func TestRebootNowAction_CustomTimeout(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reboot_now" "custom_timeout" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
