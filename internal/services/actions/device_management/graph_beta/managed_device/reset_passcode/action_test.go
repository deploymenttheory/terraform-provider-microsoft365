package graphBetaResetManagedDevicePasscode_test
...
func TestResetPasscodeAction_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "partial_failures" {
  config {
    device_ids = [
...
func TestResetPasscodeAction_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "validation_disabled" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestResetPasscodeAction_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "validation_enabled" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001"
    ]
...
func TestResetPasscodeAction_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "invalid_device_id" {
  config {
    device_ids = [
      "not-a-valid-guid"
    ]
...
func TestResetPasscodeAction_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "no_devices" {
  config {
    device_ids = []
  }
}
...
func TestResetPasscodeAction_DuplicateDeviceIDs(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "duplicate_device_ids" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001",
      "00000000-0000-0000-0000-000000000001"
...
func TestResetPasscodeAction_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_reset_passcode" "multiple_devices" {
  config {
    device_ids = [
      "00000000-0000-0000-0000-000000000001",
