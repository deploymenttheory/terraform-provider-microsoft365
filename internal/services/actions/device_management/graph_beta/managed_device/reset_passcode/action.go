...
const (
	ActionName    = "microsoft365_graph_beta_device_management_managed_device_reset_passcode"
	InvokeTimeout = 60
)
	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"validate_device_exists": schema.BoolAttribute{
				Optional: true,
				MarkdownDescription: "Whether to validate that devices exist and are Android devices before attempting passcode reset. " +
