...
const (
	ActionName = "graph_beta_device_management_managed_device_logout_shared_apple_device_active_user"
)
...
func (a *LogoutSharedAppleDeviceActiveUserAction) FullTypeName() string {
