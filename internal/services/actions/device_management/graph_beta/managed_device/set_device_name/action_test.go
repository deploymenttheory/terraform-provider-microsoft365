package graphBetaSetDeviceNameManagedDevice_test
...
func TestUnitActionSetDeviceNameManagedDevice_03_ComanagedOnly(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "comanaged_only" {
  config {
    comanaged_devices = [
      {
        device_id   = "00000000-0000-0000-0000-000000000001"
        device_name = "NYC-IT-Workstation-01"
      }
    ]
  }
}
...
func TestUnitActionSetDeviceNameManagedDevice_04_PartialFailures(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "partial_failures" {
  config {
    managed_devices = [
      {
        device_id   = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionSetDeviceNameManagedDevice_05_ValidationDisabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "validation_disabled" {
  config {
    managed_devices = [
      {
        device_id   = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionSetDeviceNameManagedDevice_06_ValidationEnabled(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "validation_enabled" {
  config {
    managed_devices = [
      {
        device_id   = "00000000-0000-0000-0000-000000000001"
...
func TestUnitActionSetDeviceNameManagedDevice_07_InvalidDeviceID(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "invalid_device_id" {
  config {
    managed_devices = [
      {
...
func TestUnitActionSetDeviceNameManagedDevice_08_NoDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "no_devices" {
  config {}
}
`,
...
func TestUnitActionSetDeviceNameManagedDevice_09_MissingDeviceName(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "missing_device_name" {
  config {
    managed_devices = [
      {
        device_id = "00000000-0000-0000-0000-000000000001"
...
`,
				ExpectError: regexp.MustCompile(`Missing required argument|device_name`),
			},
		},
	})
}
...
func TestUnitActionSetDeviceNameManagedDevice_10_MultipleDevices(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: `
action "microsoft365_graph_beta_device_management_managed_device_set_device_name" "multiple_devices" {
  config {
    managed_devices = [
      {
        device_id   = "00000000-0000-0000-0000-000000000001"
        device_name = "NYC-Laptop-01"
      },
      {
        device_id   = "00000000-0000-0000-0000-000000000002"
        device_name = "NYC-Laptop-02"
      },
      {
        device_id   = "00000000-0000-0000-0000-000000000003"
        device_name = "NYC-Laptop-03"
      }
    ]
  }
}
