...
func (m *CleanWindowsDeviceMock) cleanManagedDeviceResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		...
		case strings.Contains(deviceID, "error"):
			errorResponse, _ := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_create", "post_clean_windows_device_error.json"))
			return httpmock.NewJsonResponse(400, errorResponse)
		case strings.Contains(deviceID, "not-found"):
			errorResponse, _ := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_delete", "post_clean_windows_device_not_found.json"))
			return httpmock.NewJsonResponse(404, errorResponse)
		default:
			// Load success response
			response, err := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_create", "post_clean_windows_device_success.json"))
			if err != nil {
...
func (m *CleanWindowsDeviceMock) getDeviceResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		...
		case strings.Contains(deviceID, "12345678-1234-1234-1234-123456789abc"):
			// Windows 10 device
			deviceResponse, _ := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_device", "get_device_windows10.json"))
			return httpmock.NewJsonResponse(200, deviceResponse)
		case strings.Contains(deviceID, "87654321-4321-4321-4321-987654321cba"):
			// Windows 11 device
			deviceResponse, _ := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_device", "get_device_windows11.json"))
			return httpmock.NewJsonResponse(200, deviceResponse)
		default:
...
func (m *CleanWindowsDeviceMock) getComanagedDeviceResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		...
		case strings.Contains(deviceID, "aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee"):
			// Co-managed device
			deviceResponse, _ := mocks.LoadJSONResponse(filepath.Join("tests", "responses", "validate_device", "get_device_comanaged.json"))
			return httpmock.NewJsonResponse(200, deviceResponse)
		default:
