...
const (
	DataSourceName = "graph_beta_windows_365_cloud_pc_device_images"
	ReadTimeout    = 180
)

var (
	_ datasource.DataSource              = &CloudPcDeviceImagesDataSource{}
	_ datasource.DataSourceWithConfigure = &CloudPcDeviceImagesDataSource{}
)

func NewCloudPcDeviceImagesDataSource() datasource.DataSource {
	return &CloudPcDeviceImagesDataSource{
...
type CloudPcDeviceImagesDataSource struct {
...
func (d *CloudPcDeviceImagesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_" + DataSourceName
}

func (d *CloudPcDeviceImagesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
	d.client = client.SetGraphBetaClientForDataSource(ctx, req, resp, d.TypeName)
}

func (d *CloudPcDeviceImagesDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
