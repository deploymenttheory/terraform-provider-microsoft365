...
// CloudPcDeviceImagesDataSourceModel represents the Terraform data source model for Cloud PC Device Images
type CloudPcDeviceImagesDataSourceModel struct {
