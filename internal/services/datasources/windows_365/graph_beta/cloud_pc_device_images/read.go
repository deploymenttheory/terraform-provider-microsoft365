...
func (d *CloudPcDeviceImagesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var object CloudPcDeviceImagesDataSourceModel
...
func (d *CloudPcDeviceImagesDataSource) getDeviceImageById(ctx context.Context, id string) (graphmodels.CloudPcDeviceImageable, error) {
...
func (d *CloudPcDeviceImagesDataSource) listDeviceImages(ctx context.Context, filterType string, filterValue string) ([]graphmodels.CloudPcDeviceImageable, error) {
