		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.#", "4"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.product_display_name", "7-Zip"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.publisher_display_name", "Igor Pavlov"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.version_display_name", "25.01"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.branch_display_name", "7-Zip (x64)"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.applicable_architectures", "x64"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.locales.#", "1"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.locales.0", "mul"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.0.package_auto_update_capable", "false"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.1.product_display_name", "3CXPhone for Windows"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.1.publisher_display_name", "3CX"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.all", "items.1.package_auto_update_capable", "true"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_id", "items.0.id", "5af1ade9-6966-3608-7e04-848252e29681"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_id", "items.0.product_id", "3a6307ef-6991-faf1-01e1-35e1557287aa"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_id", "items.0.product_display_name", "7-Zip"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_id", "items.0.publisher_display_name", "Igor Pavlov"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_product_name", "items.#", "1"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_product_name", "items.0.product_display_name", "7-Zip"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_publisher_name", "filter_value", "Igor Pavlov"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_publisher_name", "items.#", "1"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.by_publisher_name", "items.0.publisher_display_name", "Igor Pavlov"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_filter", "odata_search", "\"productDisplayName:7-Zip\""),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_filter", "items.#", "2"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_filter", "items.0.product_display_name", "7-Zip"),
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_filter", "items.1.product_display_name", "3CXPhone for Windows"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_advanced", "items.#", "4"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_graph_beta_device_and_app_management_mobile_app_catalog_packages.odata_comprehensive", "items.#", "2"),
				),
			},
		},
	})
