...
var (
	...
	_ datasource.DataSource = &Microsoft365EndpointReferenceDataSource{}

	// Allows the datasource to be configured with the provider client
	_ datasource.DataSourceWithConfigure = &Microsoft365EndpointReferenceDataSource{}
)

func NewMicrosoft365EndpointReferenceDataSource() datasource.DataSource {
	return &Microsoft365EndpointReferenceDataSource{}
}
