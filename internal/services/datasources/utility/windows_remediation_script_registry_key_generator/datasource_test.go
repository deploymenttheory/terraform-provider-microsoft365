		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "value_type", "REG_SZ"),
					...
					resource.TestMatchResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "remediation_script", regexp.MustCompile("'Enabled'")),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "value_type", "REG_MULTI_SZ"),
					resource.TestMatchResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "remediation_script", regexp.MustCompile("PropertyType MultiString")),
					resource.TestMatchResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "remediation_script", regexp.MustCompile(`@\(`)),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "value_type", "REG_BINARY"),
					resource.TestMatchResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "remediation_script", regexp.MustCompile("PropertyType Binary")),
					resource.TestMatchResourceAttr("data.microsoft365_windows_remediation_script_registry_key_generator.test", "remediation_script", regexp.MustCompile("0x01")),
				),
			},
		},
	})
