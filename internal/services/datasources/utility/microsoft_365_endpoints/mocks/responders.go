...
func init() {
	...
	mocks.GlobalRegistry.Register("microsoft_365_endpoints", &Microsoft365EndpointsMock{})
}

// Microsoft365EndpointsMock provides mock responses for Microsoft 365 endpoints operations
type Microsoft365EndpointsMock struct{}

// Ensure Microsoft365EndpointsMock implements MockRegistrar interface
var _ mocks.MockRegistrar = (*Microsoft365EndpointsMock)(nil)
...
func (m *Microsoft365EndpointsMock) RegisterMocks() {
...
func (m *Microsoft365EndpointsMock) RegisterErrorMocks() {
...
func (m *Microsoft365EndpointsMock) CleanupMockState() {
	// This datasource is read-only, no state to clean up
}

// loadJSONResponse loads a JSON response from a file
func (m *Microsoft365EndpointsMock) loadJSONResponse(filePath string) ([]map[string]any, error) {
...
func (m *Microsoft365EndpointsMock) getEndpointsResponder(instance string) httpmock.Responder {
...
func (m *Microsoft365EndpointsMock) applyFilters(data []map[string]any, req *http.Request) []map[string]any {
