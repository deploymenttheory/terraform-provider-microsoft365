...
//   - setting: A `sharedmodels.Setting` object representing an individual setting to process.
...
func processSetting(ctx context.Context, setting sharedmodels.Setting, settingsRequestPayload *[]graphmodels.DeviceManagementConfigurationSettingable) {
...
func createBaseInstance(ctx context.Context, odataType string, settingDefinitionId string) (any, string) {
	if odataType == "" {
...
// - ChoiceSettingValue
// - SimpleSettingValue
func setValueTemplateReference(value any, ref *sharedmodels.SettingValueTemplateReference) {
	if ref != nil {
