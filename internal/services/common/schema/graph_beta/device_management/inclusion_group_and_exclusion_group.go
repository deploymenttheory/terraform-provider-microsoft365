...
// InclusionGroupAndExclusionGroupAssignmentsSchema returns the schema for the assignments block. This is used by the resources
// Android Enterprise Notifications and Android device administrator Notifications
func InclusionGroupAndExclusionGroupAssignmentsSchema() schema.SetNestedAttribute {
