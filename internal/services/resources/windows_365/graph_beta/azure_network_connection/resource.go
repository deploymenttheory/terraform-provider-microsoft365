...
const (
	ResourceName  = "microsoft365_graph_beta_windows_365_azure_network_connection"
	CreateTimeout = 180
	UpdateTimeout = 180
	ReadTimeout   = 180
	DeleteTimeout = 180
...
var (
	...
	_ resource.ResourceWithIdentity = &CloudPcOnPremisesConnectionResource{}
)
...
func (r *CloudPcOnPremisesConnectionResource) IdentitySchema(ctx context.Context, req resource.IdentitySchemaRequest, resp *resource.IdentitySchemaResponse) {
