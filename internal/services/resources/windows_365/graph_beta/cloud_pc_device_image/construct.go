...
func constructResource(ctx context.Context, data *CloudPcDeviceImageResourceModel, client *msgraphbetasdk.GraphServiceClient) (*models.CloudPcDeviceImage, error) {
