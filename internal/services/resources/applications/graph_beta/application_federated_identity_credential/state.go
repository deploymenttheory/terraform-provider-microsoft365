...
func MapRemoteStateFromSDK(ctx context.Context, data *ApplicationFederatedIdentityCredentialResourceModel, credential graphmodels.FederatedIdentityCredentialable) {
