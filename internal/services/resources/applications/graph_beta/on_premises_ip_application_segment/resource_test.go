package graphBetaApplicationsOnPremisesIpApplicationSegment_test
...
import (
	...
	ipSegmentMocks "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/applications/graph_beta/on_premises_ip_application_segment/mocks"
	"github.com/hashicorp/terraform-plugin-testing/helper/resource"
	"github.com/jarcoal/httpmock"
)

func setupMockEnvironment() (*mocks.Mocks, *ipSegmentMocks.OnPremisesIpApplicationSegmentMock) {
	httpmock.Activate()
	mockClient := mocks.NewMocks()
	mockClient.AuthMocks.RegisterMocks()
	ipSegmentMock := &ipSegmentMocks.OnPremisesIpApplicationSegmentMock{}
	ipSegmentMock.RegisterMocks()
	return mockClient, ipSegmentMock
}

func setupErrorMockEnvironment() (*mocks.Mocks, *ipSegmentMocks.OnPremisesIpApplicationSegmentMock) {
	httpmock.Activate()
	mockClient := mocks.NewMocks()
	mockClient.AuthMocks.RegisterMocks()
	ipSegmentMock := &ipSegmentMocks.OnPremisesIpApplicationSegmentMock{}
...
func TestUnitResourceIpApplicationSegment_01_Minimal(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// Ports
					resource.TestCheckResourceAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_minimal", "ports.#", "1"),
					resource.TestCheckTypeSetElemAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_minimal", "ports.*", "80-80"),
				),
			},
		},
	})
...
func TestUnitResourceIpApplicationSegment_02_Maximal(t *testing.T) {
	mocks.SetupUnitTestEnvironment(t)
	_, ipSegmentMock := setupMockEnvironment()
	defer httpmock.DeactivateAndReset()
	defer ipSegmentMock.CleanupMockState()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckTypeSetElemAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_maximal", "ports.*", "80-80"),
					resource.TestCheckTypeSetElemAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_maximal", "ports.*", "443-443"),
					resource.TestCheckTypeSetElemAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_maximal", "ports.*", "8080-8080"),
					resource.TestCheckTypeSetElemAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_maximal", "ports.*", "8443-8443"),
				),
			},
		},
	})
...
func TestUnitResourceIpApplicationSegment_03_IpRange(t *testing.T) {
	mocks.SetupUnitTestEnvironment(t)
	_, ipSegmentMock := setupMockEnvironment()
	defer httpmock.DeactivateAndReset()
	defer ipSegmentMock.CleanupMockState()
...
func TestUnitResourceIpApplicationSegment_05_Update(t *testing.T) {
	mocks.SetupUnitTestEnvironment(t)
	_, ipSegmentMock := setupMockEnvironment()
	defer httpmock.DeactivateAndReset()
	defer ipSegmentMock.CleanupMockState()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_minimal", "ports.#", "1"),
					testCheckExists("microsoft365_graph_beta_applications_on_premises_ip_application_segment.ip_segment_minimal"),
				),
			},
			{
