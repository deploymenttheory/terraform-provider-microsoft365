...
func MapRemoteResourceStateToTerraform(ctx context.Context, data *OnPremisesIpApplicationSegmentResourceModel, remoteResource graphmodels.IpApplicationSegmentable) {
