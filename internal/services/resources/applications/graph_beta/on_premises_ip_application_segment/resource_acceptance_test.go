...
var (
	...
	resourceType = graphBetaApplicationsOnPremisesIpApplicationSegment.ResourceName

	// testResource is the test resource implementation for IP application segments
	testResource = graphBetaApplicationsOnPremisesIpApplicationSegment.OnPremisesIpApplicationSegmentTestResource{}
)
