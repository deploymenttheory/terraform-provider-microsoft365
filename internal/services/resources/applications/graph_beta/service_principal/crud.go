...
import (
	...
	directory "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/common/crud/graph_beta/directory"
...
//
// Operation: Creates a new service principal from an application
// API Calls:
//   - POST /servicePrincipals
//
// Reference: https://learn.microsoft.com/en-us/graph/api/serviceprincipal-post-serviceprincipals?view=graph-rest-beta
func (r *ServicePrincipalResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var object ServicePrincipalResourceModel
...
// Read handles the Read operation for Service Principal resources.
//
// Operation: Retrieves a service principal by ID
// API Calls:
...
func (r *ServicePrincipalResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	object = MapRemoteStateToTerraform(ctx, object, remoteResource)
...
// Update handles the Update operation for Service Principal resources.
//
...
// Delete handles the Delete operation for Service Principal resources.
//
// Operation: Deletes a service principal with optional hard delete
// API Calls:
...
func (r *ServicePrincipalResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data ServicePrincipalResourceModel
	...
	servicePrincipalId := data.ID.ValueString()

	// Define the soft delete function for service principals
