...
type ApplicationResourceModel struct {
	...
	Api                            *ApplicationApi                     `tfsdk:"api"`
	AppRoles                       types.Set                           `tfsdk:"app_roles"`
	Info                           *ApplicationInformationalUrl        `tfsdk:"info"`
	KeyCredentials                 types.Set                           `tfsdk:"key_credentials"`
	PasswordCredentials            types.Set                           `tfsdk:"password_credentials"`
	OptionalClaims                 *ApplicationOptionalClaims          `tfsdk:"optional_claims"`
	ParentalControlSettings        *ApplicationParentalControlSettings `tfsdk:"parental_control_settings"`
	PublicClient                   *ApplicationPublicClient            `tfsdk:"public_client"`
	RequiredResourceAccess         types.Set                           `tfsdk:"required_resource_access"`
	Spa                            *ApplicationSpa                     `tfsdk:"spa"`
...
type ApplicationWeb struct {
	...
	RedirectUris         types.Set                           `tfsdk:"redirect_uris"`
	ImplicitGrantSettings *ApplicationWebImplicitGrantSettings `tfsdk:"implicit_grant_settings"`
