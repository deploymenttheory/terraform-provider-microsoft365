...
// ApplicationIdentifierUriTestResource implements the types.TestResource interface
type ApplicationIdentifierUriTestResource struct{}

// Exists checks whether the identifier URI exists on the application.
func (r ApplicationIdentifierUriTestResource) Exists(ctx context.Context, _ any, state *terraform.InstanceState) (*bool, error) {
