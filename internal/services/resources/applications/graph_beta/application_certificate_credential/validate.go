...
func validateRequest(ctx context.Context, data *ApplicationCertificateCredentialResourceModel) error {
	tflog.Debug(ctx, "Starting validation of application certificate credential request")
	...
	tflog.Debug(ctx, "Successfully validated application certificate credential request")
	return nil
}
...
func validateCredentialStartDateIsNotInThePast(ctx context.Context, data *ApplicationCertificateCredentialResourceModel) error {
...
func validateCredentialEndDateIsAfterStartDate(ctx context.Context, data *ApplicationCertificateCredentialResourceModel) error {
