...
func constructAddPasswordRequest(ctx context.Context, data *ApplicationPasswordCredentialResourceModel) (*applications.ItemAddPasswordPostRequestBody, error) {
