...
func MapRemoteResourceStateToTerraform(ctx context.Context, data *ApplicationPasswordCredentialResourceModel, credential graphmodels.PasswordCredentialable) {
	if credential == nil {
