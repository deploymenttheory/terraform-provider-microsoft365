...
func validateRequest(ctx context.Context, data *ApplicationPasswordCredentialResourceModel) error {
	tflog.Debug(ctx, "Starting validation of application password credential request")
	...
	tflog.Debug(ctx, "Successfully validated application password credential request")
	return nil
}
...
func validateCredentialStartDateIsNotInThePast(ctx context.Context, data *ApplicationPasswordCredentialResourceModel) error {
...
func validateCredentialEndDateIsAfterStartDate(ctx context.Context, data *ApplicationPasswordCredentialResourceModel) error {
