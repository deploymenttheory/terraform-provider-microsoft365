		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceTypeAcc+".minimal").Key("target_group_id").HasValue("00000000-0000-0000-0000-000000000002"),
					check.That(resourceTypeAcc+".minimal").Key("resource_object_id").HasValue("00000000-0000-0000-0000-000000000010"),
					check.That(resourceTypeAcc+".minimal").Key("app_role_id").HasValue("00000000-0000-0000-0000-000000000000"),
					check.That(resourceTypeAcc+".minimal").Key("principal_display_name").Exists(),
					check.That(resourceTypeAcc+".minimal").Key("resource_display_name").Exists(),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceTypeAcc+".maximal").Key("target_group_id").HasValue("00000000-0000-0000-0000-000000000003"),
					check.That(resourceTypeAcc+".maximal").Key("resource_object_id").HasValue("00000000-0000-0000-0000-000000000011"),
					check.That(resourceTypeAcc+".maximal").Key("app_role_id").HasValue("00000000-0000-0000-0000-000000000000"),
					check.That(resourceTypeAcc+".maximal").Key("principal_display_name").Exists(),
					check.That(resourceTypeAcc+".maximal").Key("resource_display_name").Exists(),
