...
func TestUnitCreateSeededRNG_Deterministic(t *testing.T) {
	seed := "test-seed"
...
func TestUnitCreateSeededRNG_DifferentSeeds(t *testing.T) {
...
func TestUnitShuffle_EmptyList(t *testing.T) {
	guids := []string{}
...
func TestUnitShuffle_SingleItem(t *testing.T) {
...
func TestUnitShuffle_MultipleItems(t *testing.T) {
...
func TestUnitShuffle_DoesNotMutateOriginal(t *testing.T) {
...
func TestUnitShuffle_Deterministic(t *testing.T) {
...
func TestUnitShuffleWithSeed_EmptyList(t *testing.T) {
	guids := []string{}
...
func TestUnitShuffleWithSeed_SingleItem(t *testing.T) {
	guids := []string{"12345678-1234-1234-1234-123456789abc"}
	shuffled := shuffleWithSeed(guids, "test-seed")
...
func TestUnitShuffleWithSeed_MultipleItems(t *testing.T) {
	guids := generateTestGUIDs(10)
	shuffled := shuffleWithSeed(guids, "test-seed")
...
func TestUnitShuffleWithSeed_Deterministic(t *testing.T) {
	guids := generateTestGUIDs(20)
	seed := "test-seed"
...
func TestUnitShuffleWithSeed_DifferentSeeds(t *testing.T) {
	guids := generateTestGUIDs(20)
...
func TestUnitShuffleWithSeed_DoesNotMutateOriginal(t *testing.T) {
	original := generateTestGUIDs(10)
	originalCopy := make([]string, len(original))
	copy(originalCopy, original)
...
func TestUnitShardByRoundRobin_EmptyList(t *testing.T) {
	guids := []string{}
...
func TestUnitShardByRoundRobin_SingleShard(t *testing.T) {
	guids := generateTestGUIDs(10)
...
func TestUnitShardByRoundRobin_PerfectDistribution(t *testing.T) {
...
func TestUnitShardByRoundRobin_PerfectDistribution_WithRemainder(t *testing.T) {
...
func TestUnitShardByRoundRobin_RealisticDistribution_512Users(t *testing.T) {
...
func TestUnitShardByRoundRobin_NoSeed_UsesInputOrder(t *testing.T) {
...
func TestUnitShardByRoundRobin_WithSeed_Deterministic(t *testing.T) {
...
func TestUnitShardByRoundRobin_DifferentSeeds_DifferentDistributions(t *testing.T) {
	guids := generateTestGUIDs(100)
...
func TestUnitShardByRoundRobin_10Shards(t *testing.T) {
	guids := generateTestGUIDs(100)
...
func TestUnitShardByPercentage_EmptyList(t *testing.T) {
	guids := []string{}
...
func TestUnitShardByPercentage_AccuratePercentages_100Users(t *testing.T) {
	guids := generateTestGUIDs(100)
	percentages := []int64{10, 30, 60}
	shards := shardByPercentage(guids, percentages, "")
...
func TestUnitShardByPercentage_RealisticPercentages_512Users(t *testing.T) {
	guids := generateTestGUIDs(512)
	percentages := []int64{10, 30, 60}
	shards := shardByPercentage(guids, percentages, "")
...
func TestUnitShardByPercentage_LastShardGetsRemainder(t *testing.T) {
...
func TestUnitShardByPercentage_NoSeed_UsesInputOrder(t *testing.T) {
	guids := generateTestGUIDs(10)
...
func TestUnitShardByPercentage_WithSeed_Deterministic(t *testing.T) {
	guids := generateTestGUIDs(100)
	percentages := []int64{10, 30, 60}
	seed := "test-seed"
...
// Test that different seeds produce different distributions
func TestUnitShardByPercentage_DifferentSeeds_DifferentDistributions(t *testing.T) {
	guids := generateTestGUIDs(100)
	percentages := []int64{10, 30, 60}
...
func TestUnitShardByPercentage_10Shards(t *testing.T) {
	guids := generateTestGUIDs(100)
...
func TestUnitShardBySize_EmptyList(t *testing.T) {
	guids := []string{}
	sizes := []int64{10, 20, -1}
...
func TestUnitShardBySize_ExactSizes(t *testing.T) {
	guids := generateTestGUIDs(100)
...
func TestUnitShardBySize_WithRemainder(t *testing.T) {
...
func TestUnitShardBySize_ZeroRemainder(t *testing.T) {
...
func TestUnitShardBySize_NotEnoughGUIDs(t *testing.T) {
	guids := generateTestGUIDs(100)
...
func TestUnitShardBySize_NoSeed_UsesInputOrder(t *testing.T) {
	guids := generateTestGUIDs(10)
	sizes := []int64{3, 4, 3}
	shards := shardBySize(guids, sizes, "")
...
func TestUnitShardBySize_WithSeed_Deterministic(t *testing.T) {
	guids := generateTestGUIDs(100)
	sizes := []int64{25, 50, -1}
	seed := "test-seed"
...
func TestUnitShardBySize_DifferentSeeds_DifferentDistributions(t *testing.T) {
	guids := generateTestGUIDs(100)
	sizes := []int64{20, 30, -1}
...
func TestUnitShardBySize_RealisticScenario_512Users(t *testing.T) {
	guids := generateTestGUIDs(512)
...
func TestUnitShardBySize_AllRemainderInMiddle_ShouldFail(t *testing.T) {
