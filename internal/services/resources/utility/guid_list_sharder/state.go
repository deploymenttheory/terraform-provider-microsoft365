...
// setStateToTerraform converts sharding results into Terraform state values.
// It computes a deterministic id from the configuration parameters and sets the shards map.
func setStateToTerraform(ctx context.Context, state *GuidListSharderResourceModel, shards [][]string, shardCount int, strategy string) error {
