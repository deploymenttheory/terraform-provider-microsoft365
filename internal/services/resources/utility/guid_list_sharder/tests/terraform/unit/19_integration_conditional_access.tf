...
resource "microsoft365_utility_guid_list_sharder" "mfa_rollout" {
  resource_type           = "users"
...
#   conditions {
#     users {
#       include_users = microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_0"]
#     }
#   }
#   
#   grant_controls {
...
#   conditions {
#     users {
#       include_users = microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_1"]
#     }
#   }
#   
#   grant_controls {
...
output "pilot_users" {
  ...
  value       = microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_0"]
}

output "pilot_count" {
  description = "Number of users in pilot phase"
  value       = length(microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_0"])
}

output "broader_count" {
  description = "Number of users in broader pilot phase"
  value       = length(microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_1"])
}

output "full_count" {
  description = "Number of users in full rollout phase"
  value       = length(microsoft365_utility_guid_list_sharder.mfa_rollout.shards["shard_2"])
}
