package graphBetaNetworkThreatIntelligencePolicy_test
...
import (
	...
	target "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/identity_and_access/graph_beta/network_threat_intelligence_policy"
...
func TestUnitResourceNetworkThreatIntelligencePolicy_01_Lifecycle(t *testing.T) {
...
func TestUnitResourceNetworkThreatIntelligencePolicy_02_InvalidAction(t *testing.T) {
...
func TestUnitResourceNetworkThreatIntelligencePolicy_03_Drift(t *testing.T) {
	m := setupMockEnvironment(t)
	resource.UnitTest(
		t,
		resource.TestCase{
