...
func MapRemoteResourceStateToTerraform(ctx context.Context, data AdministrativeUnitRoleAssignmentResourceModel, remoteResource graphmodels.ScopedRoleMembershipable) AdministrativeUnitRoleAssignmentResourceModel {
	...
	data.RoleID = convert.GraphToFrameworkString(remoteResource.GetRoleId())
