...
resource "microsoft365_graph_beta_identity_and_access_administrative_unit_role_assignment" "aura002_helpdesk_admin" {
  administrative_unit_id = microsoft365_graph_beta_identity_and_access_administrative_unit.aura002_au.id
  role_id                = data.microsoft365_graph_beta_identity_and_access_directory_role.helpdesk_admin.items[0].id
