...
# ==============================================================================
# Time Sleep - Allow user and group objects to propagate before the
# cross-tenant access policy is patched with their IDs.
# ==============================================================================
...
# ==============================================================================
# Cross-Tenant Access Default Settings - Maximal
#
# All available blocks are configured. b2b_direct_connect_outbound targets
# specific users and groups created as dependencies above.
# ==============================================================================
