...
# ==============================================================================
# Cross-Tenant Access Default Settings - Update Maximal → Minimal (Step 1)
#
# Full maximal configuration with all blocks and specific user/group targets.
# Step 2 will reduce this to the minimal configuration.
# ==============================================================================
