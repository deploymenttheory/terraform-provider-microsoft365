...
resource "microsoft365_graph_beta_identity_and_access_conditional_access_policy" "caau002_o365" {
  display_name = "acc-test-caau002-o365: Block agent identity access for All agentic identities to all applications when Risk is medium or higher ${random_string.suffix.result}"
