...
// TestAccResourceNetworkExplicitForwardProxy_01_Lifecycle requires explicit approval to update tenant-wide proxy settings.
func TestAccResourceNetworkExplicitForwardProxy_01_Lifecycle(t *testing.T) {
			...
			Steps: []resource.TestStep{
				{
					...
					Check: check.That(resourceType + ".test").
						ExistsInGraph(target.NetworkExplicitForwardProxyTestResource{}),
				},
				{
