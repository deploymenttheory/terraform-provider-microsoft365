...
type AdministrativeUnitDirectoryRoleAssignmentTestResource struct{}

func (r AdministrativeUnitDirectoryRoleAssignmentTestResource) Exists(ctx context.Context, _ any, state *terraform.InstanceState) (*bool, error) {
	//nolint:wrapcheck
