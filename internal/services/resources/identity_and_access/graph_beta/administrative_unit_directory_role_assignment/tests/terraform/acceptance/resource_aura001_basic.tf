...
resource "microsoft365_graph_beta_identity_and_access_administrative_unit_directory_role_assignment" "aura001_basic" {
  administrative_unit_id = microsoft365_graph_beta_identity_and_access_administrative_unit.aura001_au.id
  directory_role_id      = data.microsoft365_graph_beta_identity_and_access_directory_role.user_admin.items[0].id
