package graphBetaAdministrativeUnitDirectoryRoleAssignment_test
...
import (
	...
	graphBetaAdministrativeUnitDirectoryRoleAssignment "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/identity_and_access/graph_beta/administrative_unit_directory_role_assignment"
	roleAssignmentMocks "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/identity_and_access/graph_beta/administrative_unit_directory_role_assignment/mocks"
...
var (
	resourceType = graphBetaAdministrativeUnitDirectoryRoleAssignment.ResourceName
	testResource = graphBetaAdministrativeUnitDirectoryRoleAssignment.AdministrativeUnitDirectoryRoleAssignmentTestResource{}
)

func setupMockEnvironment() (*mocks.Mocks, *roleAssignmentMocks.AdministrativeUnitDirectoryRoleAssignmentMock) {
	httpmock.Activate()
	mockClient := mocks.NewMocks()
	mockClient.AuthMocks.RegisterMocks()

	roleAssignmentMock := &roleAssignmentMocks.AdministrativeUnitDirectoryRoleAssignmentMock{}
	roleAssignmentMock.RegisterMocks()
	return mockClient, roleAssignmentMock
}

func setupErrorMockEnvironment() (*mocks.Mocks, *roleAssignmentMocks.AdministrativeUnitDirectoryRoleAssignmentMock) {
	httpmock.Activate()
	mockClient := mocks.NewMocks()
	mockClient.AuthMocks.RegisterMocks()
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceType+".aura001_basic").Key("directory_role_id").HasValue("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceType+".aura002_different_member").Key("directory_role_id").HasValue("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
