...
type AdministrativeUnitDirectoryRoleAssignmentMock struct{}

func (m *AdministrativeUnitDirectoryRoleAssignmentMock) RegisterMocks() {
	mockState.Lock()
	mockState.assignments = make(map[string]map[string]scopedRoleAssignment)
	mockState.Unlock()
...
func (m *AdministrativeUnitDirectoryRoleAssignmentMock) registerDirectoryObjectValidationResponder() {
...
func (m *AdministrativeUnitDirectoryRoleAssignmentMock) registerPostScopedRoleMemberResponder() {
...
func (m *AdministrativeUnitDirectoryRoleAssignmentMock) registerGetScopedRoleMemberResponder() {
...
func (m *AdministrativeUnitDirectoryRoleAssignmentMock) registerDeleteScopedRoleMemberResponder() {
...
func (m *AdministrativeUnitDirectoryRoleAssignmentMock) RegisterErrorMocks() {
	httpmock.RegisterResponder("POST", `=~^https://graph\.microsoft\.com/beta/administrativeUnits/([^/]+)/scopedRoleMembers$`,
