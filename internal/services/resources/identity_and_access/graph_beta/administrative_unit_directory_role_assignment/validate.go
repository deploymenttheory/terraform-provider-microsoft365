...
func validateRequest(ctx context.Context, client *msgraphbetasdk.GraphServiceClient, data *AdministrativeUnitDirectoryRoleAssignmentResourceModel, diagnostics *diag.Diagnostics) bool {
