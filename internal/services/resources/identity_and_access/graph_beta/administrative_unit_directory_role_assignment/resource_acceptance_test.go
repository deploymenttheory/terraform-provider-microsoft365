		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceType+".aura001_basic").Key("directory_role_id").IsNotEmpty(),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					check.That(resourceType+".aura002_helpdesk_admin").Key("directory_role_id").IsNotEmpty(),
...
// AURA003: Replace test — changing directory_role_id forces a new resource
