...
func (r *NetworkTLSInspectionPolicyResource) Create(
	ctx context.Context,
	req resource.CreateRequest,
	resp *resource.CreateResponse,
) {
	var object NetworkTLSInspectionPolicyResourceModel
	...
	created, err := r.createTLSInspectionPolicy(ctx, body)
	if err != nil {
	...
	remote, err := r.getTLSInspectionPolicy(ctx, object.ID.ValueString())
...
func (r *NetworkTLSInspectionPolicyResource) Read(
	ctx context.Context,
...
func (r *NetworkTLSInspectionPolicyResource) Update(
	ctx context.Context,
	req resource.UpdateRequest,
	resp *resource.UpdateResponse,
) {
	var plan, state NetworkTLSInspectionPolicyResourceModel
...
func (r *NetworkTLSInspectionPolicyResource) Delete(
	ctx context.Context,
	...
	defer cancel()
	if err := r.deleteTLSInspectionPolicy(ctx, object.ID.ValueString()); err != nil {
		errors.HandleKiotaGraphError(
			ctx,
			err,
			resp,
