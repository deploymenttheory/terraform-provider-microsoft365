# ==============================================================================
# Cross-Tenant Access Partner Settings - Update Minimal to Maximal (Step 2)
#
# Step 2: Expand to maximal configuration with all blocks populated.
# This demonstrates the PATCH update capability of the resource.
# ==============================================================================
