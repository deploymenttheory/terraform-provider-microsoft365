...
func constructResource(ctx context.Context, data *CrossTenantAccessPartnerGroupSyncSettingsResourceModel) (graphmodels.CrossTenantIdentitySyncPolicyPartnerable, error) {
	...
	if data.GroupSyncInbound != nil {
		groupSyncInbound := graphmodels.NewCrossTenantGroupSyncInbound()
		convert.FrameworkToGraphBool(data.GroupSyncInbound.IsSyncAllowed, groupSyncInbound.SetIsSyncAllowed)
