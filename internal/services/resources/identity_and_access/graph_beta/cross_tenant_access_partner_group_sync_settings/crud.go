...
// Create creates a new cross-tenant access partner group sync settings configuration.
...
func (r *CrossTenantAccessPartnerGroupSyncSettingsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var object CrossTenantAccessPartnerGroupSyncSettingsResourceModel
...
// Read retrieves the current state of the cross-tenant access partner group sync settings from the Graph API.
//
// API Calls:
...
func (r *CrossTenantAccessPartnerGroupSyncSettingsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var object CrossTenantAccessPartnerGroupSyncSettingsResourceModel
...
// Update updates an existing cross-tenant access partner group sync settings configuration.
//
// API Calls:
//   - PUT /policies/crossTenantAccessPolicy/partners/{tenant-id}/identitySynchronization
//
// Reference: https://learn.microsoft.com/en-us/graph/api/crosstenantidentitysyncpolicypartner-update?view=graph-rest-beta
func (r *CrossTenantAccessPartnerGroupSyncSettingsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var object CrossTenantAccessPartnerGroupSyncSettingsResourceModel
...
// Delete removes the cross-tenant access partner group sync settings configuration.
//
// API Calls:
...
func (r *CrossTenantAccessPartnerGroupSyncSettingsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var object CrossTenantAccessPartnerGroupSyncSettingsResourceModel
