...
// mockState holds the in-memory state for partner group sync settings.
...
func init() {
	...
	mocks.GlobalRegistry.Register("cross_tenant_access_partner_group_sync_settings", &CrossTenantAccessPartnerGroupSyncSettingsMock{})
}

// CrossTenantAccessPartnerGroupSyncSettingsMock provides mock responses for partner group sync settings operations.
type CrossTenantAccessPartnerGroupSyncSettingsMock struct{}

// Ensure CrossTenantAccessPartnerGroupSyncSettingsMock implements MockRegistrar interface.
var _ mocks.MockRegistrar = (*CrossTenantAccessPartnerGroupSyncSettingsMock)(nil)

// RegisterMocks registers HTTP mock responses for partner group sync settings operations.
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) RegisterMocks() {
	mockState.Lock()
	mockState.settings = make(map[string]map[string]any)
	mockState.Unlock()
...
// putSettingsResponder handles PUT requests to create/update partner group sync settings
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) putSettingsResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		...
		response, err := loadJSONResponse("put_partner_group_sync_settings_success.json")
		if err != nil {
		...
		maps.Copy(response, requestBody)
...
// getSettingsResponder handles GET requests to read partner group sync settings
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) getSettingsResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		// Extract tenant ID from URL
		tenantID := "12345678-1234-1234-1234-123456789012" // Default for tests
...
// deleteSettingsResponder handles DELETE requests to remove partner group sync settings
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) deleteSettingsResponder() httpmock.Responder {
	return func(req *http.Request) (*http.Response, error) {
		// Extract tenant ID from URL
		tenantID := "12345678-1234-1234-1234-123456789012" // Default for tests
...
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) RegisterErrorMocks() {
	httpmock.RegisterResponder("PUT", `=~^https://graph\.microsoft\.com/beta/policies/crossTenantAccessPolicy/partners/([^/]+)/identitySynchronization$`,
...
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) registerTenantValidationMock() {
...
func (m *CrossTenantAccessPartnerGroupSyncSettingsMock) CleanupMockState() {
	mockState.Lock()
