...
func TestUnitResourceNetworkMCPPolicy_17_CreateErrors(t *testing.T) {
...
func TestUnitResourceNetworkMCPPolicy_17_CreateRetries429(t *testing.T) {
	posts := 0
	r := testClient(t, func(w http.ResponseWriter, q *http.Request) {
		switch q.Method {
...
func TestUnitResourceNetworkMCPPolicy_19_NoAPIPatchForUnchangedFields(t *testing.T) {
	patches := 0
	r := testClient(t, func(w http.ResponseWriter, q *http.Request) {
		if q.Method == "PATCH" {
			patches++
...
func TestUnitResourceNetworkMCPPolicy_20_IdentityImport(t *testing.T) {
	r := NewNetworkMCPPolicyResource().(*NetworkMCPPolicyResource)
...
func TestUnitResourceNetworkMCPPolicy_21_InvalidReadResponsePreservesState(t *testing.T) {
