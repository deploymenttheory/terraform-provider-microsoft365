...
// Entra Global Secure Access MCP policy blade.
func constructResource(
	ctx context.Context,
	data *NetworkMCPPolicyResourceModel,
) (s.Parsable, error) {
	requestBody := &mcpPolicyRequestBody{
		settings: &mcpPolicySettingsRequestBody{
...
func constructUpdateResource(
	ctx context.Context,
	plan, state *NetworkMCPPolicyResourceModel,
) (*mcpPolicyRequestBody, error) {
	requestBody := &mcpPolicyRequestBody{}
	...
	if !plan.DefaultAction.Equal(state.DefaultAction) {
		requestBody.settings = &mcpPolicySettingsRequestBody{
...
type mcpPolicyRequestBody struct {
	name           *string
	description    *string
	descriptionSet bool
	settings       *mcpPolicySettingsRequestBody
...
func (b *mcpPolicyRequestBody) Serialize(writer s.SerializationWriter) error {
...
func (b *mcpPolicyRequestBody) GetFieldDeserializers() map[string]func(s.ParseNode) error {
	return map[string]func(s.ParseNode) error{}
}

type mcpPolicySettingsRequestBody struct {
	defaultAction *string
}

func (b *mcpPolicySettingsRequestBody) Serialize(writer s.SerializationWriter) error {
	return wrapSerializationError(writer.WriteStringValue("defaultAction", b.defaultAction))
}

func (b *mcpPolicySettingsRequestBody) GetFieldDeserializers() map[string]func(s.ParseNode) error {
	return map[string]func(s.ParseNode) error{}
}

// hasChanges excludes Terraform-only changes such as timeouts from empty Graph PATCH requests.
func (b *mcpPolicyRequestBody) hasChanges() bool {
	return b.name != nil || b.descriptionSet || b.settings != nil
}

func wrapSerializationError(err error) error {
	if err != nil {
		return fmt.Errorf("serialize MCP policy: %w", err)
	}
	return nil
}
