...
func MapRemoteStateToTerraform(ctx context.Context, data WindowsQualityUpdateProfileAssignmentResourceModel, assignment graphmodels.WindowsQualityUpdateProfileAssignmentable) WindowsQualityUpdateProfileAssignmentResourceModel {
	if assignment == nil {
