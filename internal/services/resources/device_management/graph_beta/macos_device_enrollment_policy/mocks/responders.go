...
type MacOSDeviceEnrollmentPolicyMock struct{}

// RegisterMocks registers HTTP mock responders for macOS ADE enrollment policy operations.
//
//nolint:gocyclo // Mock registration functions naturally have high complexity
func (m *MacOSDeviceEnrollmentPolicyMock) RegisterMocks() {
	resetMockState()
