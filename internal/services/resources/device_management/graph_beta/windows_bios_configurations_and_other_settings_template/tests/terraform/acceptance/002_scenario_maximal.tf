...
resource "microsoft365_graph_beta_device_management_windows_bios_configurations_and_other_settings_template" "test_002" {
  display_name                  = "acc-test-windows-bios-configuration-002-maximal-${random_string.test_suffix.result}"
  description                   = "Maximal BIOS configuration template"
  file_name                     = "test-bios-002.cctk"
