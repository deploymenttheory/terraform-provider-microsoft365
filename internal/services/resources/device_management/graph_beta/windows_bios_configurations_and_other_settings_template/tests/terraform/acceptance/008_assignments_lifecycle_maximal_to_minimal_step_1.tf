...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_008_4" {
  display_name     = "acc-test-group-008-4-${random_string.test_suffix.result}"
  mail_nickname    = "acc-test-group-008-4-${random_string.test_suffix.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_008_5" {
  display_name     = "acc-test-group-008-5-${random_string.test_suffix.result}"
  mail_nickname    = "acc-test-group-008-5-${random_string.test_suffix.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_device_management_windows_bios_configurations_and_other_settings_template" "test_008" {
  display_name               = "acc-test-windows-bios-configuration-008-assignments-lifecycle-${random_string.test_suffix.result}"
  file_name                  = "test-bios-008.cctk"
  ...
  assignments = [
    ...
    },
    {
      ...
      group_id = microsoft365_graph_beta_groups_group.acc_test_group_008_4.id
    },
    {
      type     = "exclusionGroupAssignmentTarget"
      group_id = microsoft365_graph_beta_groups_group.acc_test_group_008_5.id
    }
  ]
