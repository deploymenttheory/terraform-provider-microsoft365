...
type WindowsBiosConfigurationsAndOtherSettingsTemplateTestResource struct{}

func (r WindowsBiosConfigurationsAndOtherSettingsTemplateTestResource) Exists(
	ctx context.Context,
	_ any,
	...
	return exists.CheckResourceExists(
		...
		func(client *msgraphbetasdk.GraphServiceClient, ctx context.Context, state *terraform.InstanceState) error {
			_, err := client.
				...
				ByHardwareConfigurationId(state.ID).
				Get(ctx, nil)
			return err
		},
	)
