...
func (r *WindowsFeatureUpdatePolicyResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
func (r *WindowsFeatureUpdatePolicyResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan WindowsFeatureUpdatePolicyResourceModel
	var state WindowsFeatureUpdatePolicyResourceModel
...
func (r *WindowsFeatureUpdatePolicyResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var object WindowsFeatureUpdatePolicyResourceModel
