...
func constructAssignment(ctx context.Context, data *WindowsFeatureUpdatePolicyResourceModel) (devicemanagement.WindowsFeatureUpdateProfilesItemAssignPostRequestBodyable, error) {
