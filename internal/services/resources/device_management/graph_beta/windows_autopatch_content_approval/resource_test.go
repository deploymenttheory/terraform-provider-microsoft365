...
import (
	...
	contentApprovalMocks "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/device_management/graph_beta/windows_autopatch_content_approval/mocks"
...
func TestUnitResourceWindowsUpdateContentApproval_04_Update(t *testing.T) {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: loadUnitTestTerraform("01_feature_update_approval.tf") + `
resource "microsoft365_graph_beta_device_management_windows_autopatch_content_approval" "test_revoked" {
