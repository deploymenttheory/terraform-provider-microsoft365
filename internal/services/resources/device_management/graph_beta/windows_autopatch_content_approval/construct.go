...
func constructResource(ctx context.Context, data *WindowsAutopatchContentApprovalResourceModel) (graphmodelswindowsupdates.ComplianceChangeable, error) {
...
func constructUpdateResource(ctx context.Context, plan *WindowsAutopatchContentApprovalResourceModel, state *WindowsAutopatchContentApprovalResourceModel) (graphmodelswindowsupdates.ComplianceChangeable, error) {
