package graphBetaWindowsAutopatchContentApproval_test
...
import (
	...
	graphBetaWindowsAutopatchContentApproval "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/device_management/graph_beta/windows_autopatch_content_approval"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config: loadAcceptanceTestTerraform("01_feature_update_approval.tf") + `
resource "microsoft365_graph_beta_device_management_windows_autopatch_content_approval" "import" {
