resource "microsoft365_graph_beta_device_management_windows_update_ring" "exclusion_assignment" {
  display_name                            = "Test Exclusion Assignment Windows Update Ring - Unique"
