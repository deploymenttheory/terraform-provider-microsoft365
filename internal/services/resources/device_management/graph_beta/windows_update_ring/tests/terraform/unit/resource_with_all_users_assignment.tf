resource "microsoft365_graph_beta_device_management_windows_update_ring" "all_users_assignment" {
  display_name                            = "Test All Users Assignment Windows Update Ring - Unique"
