...
resource "microsoft365_graph_beta_device_management_windows_update_ring" "test_007" {
  display_name                            = "unit-test-windows-update-ring-007-lifecycle-${random_string.test_007.result}"
  description                             = "Lifecycle Step 5: Auto Install and Reboot Without End User Control"
