...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_010_1" {
  display_name     = "unit-test-group-010-1-${random_string.test_010.result}"
  mail_nickname    = "unit-test-group-010-1-${random_string.test_010.result}"
  mail_enabled     = false
...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_010_2" {
  display_name     = "unit-test-group-010-2-${random_string.test_010.result}"
  mail_nickname    = "unit-test-group-010-2-${random_string.test_010.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_010_3" {
  display_name     = "unit-test-group-010-3-${random_string.test_010.result}"
  mail_nickname    = "unit-test-group-010-3-${random_string.test_010.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_device_management_windows_update_ring" "test_010" {
  display_name                            = "unit-test-windows-update-ring-010-assignments-lifecycle-${random_string.test_010.result}"
