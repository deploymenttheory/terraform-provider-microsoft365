...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_011_1" {
  display_name     = "unit-test-group-011-1-${random_string.test_011.result}"
  mail_nickname    = "unit-test-group-011-1-${random_string.test_011.result}"
  mail_enabled     = false
...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_011_2" {
  display_name     = "unit-test-group-011-2-${random_string.test_011.result}"
  mail_nickname    = "unit-test-group-011-2-${random_string.test_011.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_groups_group" "unit_test_group_011_3" {
  display_name     = "unit-test-group-011-3-${random_string.test_011.result}"
  mail_nickname    = "unit-test-group-011-3-${random_string.test_011.result}"
  mail_enabled     = false
  security_enabled = true
...
resource "microsoft365_graph_beta_device_management_windows_update_ring" "test_011" {
  display_name                            = "unit-test-windows-update-ring-011-assignments-downgrade-${random_string.test_011.result}"
  ...
  assignments = [
    {
      ...
      group_id    = microsoft365_graph_beta_groups_group.unit_test_group_011_1.id
      filter_type = "none"
      filter_id   = "00000000-0000-0000-0000-000000000000"
    },
    {
      type        = "groupAssignmentTarget"
      group_id    = microsoft365_graph_beta_groups_group.unit_test_group_011_2.id
      filter_type = "none"
      filter_id   = "00000000-0000-0000-0000-000000000000"
    },
    {
    ...
    },
    {
      ...
      group_id    = microsoft365_graph_beta_groups_group.unit_test_group_011_3.id
      filter_type = "none"
      filter_id   = "00000000-0000-0000-0000-000000000000"
    }
  ]
