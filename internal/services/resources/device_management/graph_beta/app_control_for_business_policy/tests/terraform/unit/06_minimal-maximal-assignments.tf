# Test 06: Minimal Configuration - Maximal Assignments
# Purpose: Deploy minimal app control policy with maximal assignments (3 assignments: allLicensedUsers, group, allDevices)

# Minimal App Control Policy with Maximal Assignments
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "minimal_maximal_assignments" {
  name        = "unit-test-app-control-policy-minimal-maximal-assignments"
  description = "Minimal app control policy with maximal assignments (allLicensedUsers, group, allDevices)"
