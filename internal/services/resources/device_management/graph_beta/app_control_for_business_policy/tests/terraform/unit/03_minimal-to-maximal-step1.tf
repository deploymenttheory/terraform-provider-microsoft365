# Test 03 Step 1: Minimal to Maximal - Initial State (Minimal)
# Purpose: Deploy minimal config, will be updated to maximal in step 2
...
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "step_test" {
  ...
  description = "Step test policy - starts minimal"
