# Test 05: Minimal Configuration - Minimal Assignments
# Purpose: Deploy minimal app control policy with minimal assignments (1 group)

# Minimal App Control Policy with Minimal Assignments
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "minimal_minimal_assignments" {
  name        = "unit-test-app-control-policy-minimal-minimal-assignments"
  description = "Minimal app control policy with minimal assignments (1 group)"
...
<SiPolicy xmlns="urn:schemas-microsoft-com:sipolicy" PolicyType="Base Policy">
  ...
  # Minimal Assignment - 1 group (hardcoded GUID)
  assignments = [
    {
