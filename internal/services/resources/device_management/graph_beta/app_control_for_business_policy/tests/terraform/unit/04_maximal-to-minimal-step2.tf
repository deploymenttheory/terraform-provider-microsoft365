# Test 04 Step 2: Maximal to Minimal - Updated State (Minimal)
# Purpose: Downgrade the policy from maximal to minimal configuration

# Downgrade to Minimal Configuration
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "step_test" {
  name        = "unit-test-app-control-policy-step-test"
  description = "Step test policy - downgraded to minimal"
