# Test 04 Step 1: Maximal to Minimal - Initial State (Maximal)
# Purpose: Deploy maximal config, will be downgraded to minimal in step 2
...
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "step_test" {
  ...
  description = "Step test policy - starts maximal with enhanced description"
