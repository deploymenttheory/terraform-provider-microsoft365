# Test 07 Step 1: Minimal Assignments to Maximal Assignments - Initial State (Minimal Assignments)
# Purpose: Deploy minimal policy with minimal assignments (1 group), will be expanded in step 2

# Start with Minimal Assignments
resource "microsoft365_graph_beta_device_management_app_control_for_business_policy" "assignment_step_test" {
  ...
  description = "Assignment step test policy - starts with minimal assignments"
