...
// constructAssignment constructs and returns a IntuneBrandingProfilesItemAssignPostRequestBody
func constructAssignment(ctx context.Context, data *IntuneBrandingProfileResourceModel) (devicemanagement.IntuneBrandingProfilesItemAssignPostRequestBodyable, error) {
	tflog.Debug(ctx, "Starting Intune Branding Profile assignment construction")

	requestBody := devicemanagement.NewIntuneBrandingProfilesItemAssignPostRequestBody()
	assignments := make([]graphmodels.IntuneBrandingProfileAssignmentable, 0)
	...
	var terraformAssignments []IntuneBrandingProfileAssignmentModel
...
func constructTarget(ctx context.Context, targetType string, assignment IntuneBrandingProfileAssignmentModel) graphmodels.DeviceAndAppManagementAssignmentTargetable {
