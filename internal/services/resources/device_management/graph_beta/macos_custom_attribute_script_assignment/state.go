...
func MapRemoteStateToTerraform(ctx context.Context, data MacosCustomAttributeScriptAssignmentResourceModel, assignment graphmodels.DeviceManagementScriptAssignmentable) MacosCustomAttributeScriptAssignmentResourceModel {
	if assignment == nil {
