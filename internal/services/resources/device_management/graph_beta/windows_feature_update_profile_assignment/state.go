...
func MapRemoteStateToTerraform(ctx context.Context, data WindowsFeatureUpdateProfileAssignmentResourceModel, assignment graphmodels.WindowsFeatureUpdateProfileAssignmentable) WindowsFeatureUpdateProfileAssignmentResourceModel {
	if assignment == nil {
