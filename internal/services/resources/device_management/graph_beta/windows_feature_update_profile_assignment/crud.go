...
// Create handles the Create operation for Windows Feature Update Profile Assignment resources.
//
...
// Read handles the Read operation for Windows Feature Update Profile Assignment resources.
//
...
func (r *WindowsFeatureUpdateProfileAssignmentResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	tflog.Debug(ctx, fmt.Sprintf("Reading %s with ID: %s for Windows Feature Update Profile: %s",
		ResourceName, object.ID.ValueString(), object.WindowsFeatureUpdateProfileId.ValueString()))
...
// Update handles the Update operation for Windows Feature Update Profile Assignment resources.
//
