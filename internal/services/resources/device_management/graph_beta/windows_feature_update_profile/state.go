...
func MapAssignmentsToTerraform(ctx context.Context, data *WindowsFeatureUpdateProfileResourceModel, assignments []graphmodels.WindowsFeatureUpdateProfileAssignmentable) {
	if len(assignments) == 0 {
