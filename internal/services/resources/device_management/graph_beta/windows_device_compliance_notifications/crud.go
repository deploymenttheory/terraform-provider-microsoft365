...
func (r *WindowsDeviceComplianceNotificationsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan WindowsDeviceComplianceNotificationsResourceModel
...
func (r *WindowsDeviceComplianceNotificationsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var state WindowsDeviceComplianceNotificationsResourceModel
...
func (r *WindowsDeviceComplianceNotificationsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan WindowsDeviceComplianceNotificationsResourceModel
	var state WindowsDeviceComplianceNotificationsResourceModel
...
func (r *WindowsDeviceComplianceNotificationsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var state WindowsDeviceComplianceNotificationsResourceModel
