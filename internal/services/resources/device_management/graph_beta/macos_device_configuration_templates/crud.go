...
func (r *MacosDeviceConfigurationTemplatesResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var object MacosDeviceConfigurationTemplatesResourceModel
...
// Read handles the Read operation for macOS configuration templates.
//
...
func (r *MacosDeviceConfigurationTemplatesResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var object MacosDeviceConfigurationTemplatesResourceModel
...
// Update handles the Update operation for macOS configuration templates.
//
...
//
// The Microsoft Graph Beta API supports direct updates of device configuration resources
...
// of both the configuration properties and its assignments.
func (r *MacosDeviceConfigurationTemplatesResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan MacosDeviceConfigurationTemplatesResourceModel
	var state MacosDeviceConfigurationTemplatesResourceModel
...
// Delete handles the Delete operation for macOS configuration templates.
//
...
func (r *MacosDeviceConfigurationTemplatesResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var object MacosDeviceConfigurationTemplatesResourceModel
