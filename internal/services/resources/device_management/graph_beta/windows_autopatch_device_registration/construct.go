...
func constructEnrollRequest(ctx context.Context, data *WindowsAutopatchDeviceRegistrationResourceModel) (graphadmin.WindowsUpdatesUpdatableAssetsMicrosoftGraphWindowsUpdatesEnrollAssetsByIdEnrollAssetsByIdPostRequestBodyable, error) {
...
func constructUnenrollRequest(ctx context.Context, data *WindowsAutopatchDeviceRegistrationResourceModel) (graphadmin.WindowsUpdatesUpdatableAssetsMicrosoftGraphWindowsUpdatesUnenrollAssetsByIdUnenrollAssetsByIdPostRequestBodyable, error) {
