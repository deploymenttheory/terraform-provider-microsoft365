...
func (r *WindowsAutopatchDeviceRegistrationResource) validateRequest(
	ctx context.Context,
	data *WindowsAutopatchDeviceRegistrationResourceModel,
...
func (r *WindowsAutopatchDeviceRegistrationResource) validateEntraDeviceExists(
	ctx context.Context,
