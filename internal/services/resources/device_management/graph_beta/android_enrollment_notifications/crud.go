...
*/
func (r *AndroidEnrollmentNotificationsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var object AndroidEnrollmentNotificationsResourceModel
...
func (r *AndroidEnrollmentNotificationsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var object AndroidEnrollmentNotificationsResourceModel
...
func (r *AndroidEnrollmentNotificationsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan AndroidEnrollmentNotificationsResourceModel
	var state AndroidEnrollmentNotificationsResourceModel
...
func (r *AndroidEnrollmentNotificationsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var object AndroidEnrollmentNotificationsResourceModel
