...
func MapAssignmentsToTerraform(ctx context.Context, data *AndroidEnrollmentNotificationsResourceModel, assignments []graphmodels.EnrollmentConfigurationAssignmentable) {
