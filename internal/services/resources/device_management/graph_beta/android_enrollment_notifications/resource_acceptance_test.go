...
func TestAccAndroidEnrollmentNotificationsResource_AndroidEmailMinimal(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_minimal_android", "id"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.email_minimal_android", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidEmailMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_maximal_android", "id"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.email_maximal_android", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidPushMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_android", "id"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_android", "display_name", "push maximal android"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_android", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidAllMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.all_android", "id"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.all_android", "display_name", "Complete Test - all android"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.all_android", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

// AndroidForWork Platform Tests
func TestAccAndroidEnrollmentNotificationsResource_AndroidForWorkEmailMinimal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_minimal_androidforwork", "id"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_minimal_androidforwork", "display_name", "email minimal androidForWork"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.email_minimal_androidforwork", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidForWorkEmailMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_maximal_androidforwork", "id"),
					...
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.email_maximal_androidforwork", "branding_options.#", "5"),
				),
			},
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.email_maximal_androidforwork", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidForWorkPushMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_androidForWork", "id"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_androidForWork", "display_name", "push maximal android"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.push_maximal_androidForWork", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}

func TestAccAndroidEnrollmentNotificationsResource_AndroidForWorkAllMaximal(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck:                 func() { mocks.TestAccPreCheck(t) },
		ProtoV6ProviderFactories: mocks.TestAccProtoV6ProviderFactories,
		CheckDestroy:             testAccCheckAndroidEnrollmentNotificationsDestroy,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("microsoft365_graph_beta_device_management_android_enrollment_notifications.all_androidforwork", "id"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_android_enrollment_notifications.all_androidforwork", "display_name", "Complete Test - all androidForWork"),
			...
			{ResourceName: "microsoft365_graph_beta_device_management_android_enrollment_notifications.all_androidforwork", ImportState: true, ImportStateVerify: true, ImportStateVerifyIgnore: []string{"branding_options", "platform_type"}},
		},
	})
}
