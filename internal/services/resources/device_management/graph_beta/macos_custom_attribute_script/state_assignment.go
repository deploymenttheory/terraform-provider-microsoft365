...
func MapRemoteAssignmentStateToTerraform(ctx context.Context, data *DeviceCustomAttributeShellScriptResourceModel, assignmentsResponse models.DeviceManagementScriptAssignmentCollectionResponseable) {
