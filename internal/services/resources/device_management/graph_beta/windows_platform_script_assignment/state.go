...
func MapRemoteStateToTerraform(ctx context.Context, data WindowsPlatformScriptAssignmentResourceModel, assignment graphmodels.DeviceManagementScriptAssignmentable) WindowsPlatformScriptAssignmentResourceModel {
	if assignment == nil {
