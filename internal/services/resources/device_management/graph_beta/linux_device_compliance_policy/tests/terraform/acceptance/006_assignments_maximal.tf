...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_006_1" {
  display_name     = "acc-test-linux-compliance-006-include-${random_string.test_suffix.result}"
...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_006_2" {
  display_name     = "acc-test-linux-compliance-006-second-${random_string.test_suffix.result}"
...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_006_3" {
  display_name     = "acc-test-linux-compliance-006-exclude-${random_string.test_suffix.result}"
...
resource "microsoft365_graph_beta_device_management_linux_device_compliance_policy" "test_006" {
  name                       = "acc-test-linux-compliance-006-${random_string.test_suffix.result}"
