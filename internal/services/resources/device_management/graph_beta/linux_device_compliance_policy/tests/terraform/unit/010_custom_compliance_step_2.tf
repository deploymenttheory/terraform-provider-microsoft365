resource "microsoft365_graph_beta_device_management_linux_device_compliance_policy" "test_010" {
  ...
  custom_compliance_rules            = "eyJSdWxlcyI6W3siU2V0dGluZ05hbWUiOiJUZXN0VmVyc2lvbiIsIk9wZXJhdG9yIjoiR3JlYXRlckVxdWFscyIsIkRhdGFUeXBlIjoiSW50NjQiLCJPcGVyYW5kIjoyfV19"
  timeouts = {
    create = "30s"
    read   = "30s"
    update = "30s"
