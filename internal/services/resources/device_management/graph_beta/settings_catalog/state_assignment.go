...
func StateConfigurationPolicyAssignment(ctx context.Context, data *SettingsCatalogSettingsAssignmentResourceModel, assignmentsResponse models.DeviceManagementConfigurationPolicyAssignmentCollectionResponseable) {
