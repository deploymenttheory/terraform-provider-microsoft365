...
func (r *IosDeviceConfigurationTemplatesResource) Create(
	ctx context.Context,
	req resource.CreateRequest,
	resp *resource.CreateResponse,
) {
	var object IosDeviceConfigurationTemplatesResourceModel
...
// Read handles the Read operation for iOS/iPadOS configuration templates.
//
...
func (r *IosDeviceConfigurationTemplatesResource) Read(
	ctx context.Context,
...
// Update handles the Update operation for iOS/iPadOS configuration templates.
//
...
func (r *IosDeviceConfigurationTemplatesResource) Update(
	ctx context.Context,
...
// Delete handles the Delete operation for iOS/iPadOS configuration templates.
//
...
func (r *IosDeviceConfigurationTemplatesResource) Delete(
	ctx context.Context,
