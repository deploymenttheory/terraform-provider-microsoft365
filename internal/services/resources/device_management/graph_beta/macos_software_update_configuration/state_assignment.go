...
func MapRemoteAssignmentStateToTerraform(ctx context.Context, data *MacOSSoftwareUpdateConfigurationResourceModel, assignmentsResponse models.DeviceConfigurationAssignmentCollectionResponseable) {
...
func MapAllDeviceAssignments(assignments *sharedmodels.DeviceManagementScriptAssignmentResourceModel, allDeviceAssignments []models.DeviceConfigurationAssignmentable) {
...
func MapAllUserAssignments(assignments *sharedmodels.DeviceManagementScriptAssignmentResourceModel, allUserAssignments []models.DeviceConfigurationAssignmentable) {
...
func MapIncludeGroupAssignments(assignments *sharedmodels.DeviceManagementScriptAssignmentResourceModel, includeGroupAssignments []models.DeviceConfigurationAssignmentable) {
...
func MapExcludeGroupAssignments(assignments *sharedmodels.DeviceManagementScriptAssignmentResourceModel, excludeGroupAssignments []models.DeviceConfigurationAssignmentable) {
...
func GetAllDeviceAssignments(assignmentsResponse models.DeviceConfigurationAssignmentCollectionResponseable) []models.DeviceConfigurationAssignmentable {
	if assignmentsResponse == nil {
		return nil
	}
	var allDeviceAssignments []models.DeviceConfigurationAssignmentable
...
func GetAllUserAssignments(assignmentsResponse models.DeviceConfigurationAssignmentCollectionResponseable) []models.DeviceConfigurationAssignmentable {
	if assignmentsResponse == nil {
		return nil
	}

	var allUserAssignments []models.DeviceConfigurationAssignmentable
	assignments := assignmentsResponse.GetValue()
...
func GetIncludeGroupAssignments(assignmentsResponse models.DeviceConfigurationAssignmentCollectionResponseable) []models.DeviceConfigurationAssignmentable {
	if assignmentsResponse == nil {
		return nil
	}

	var includeGroupAssignments []models.DeviceConfigurationAssignmentable
	assignments := assignmentsResponse.GetValue()
...
func GetExcludeGroupAssignments(assignmentsResponse models.DeviceConfigurationAssignmentCollectionResponseable) []models.DeviceConfigurationAssignmentable {
	if assignmentsResponse == nil {
		return nil
	}

	var excludeGroupAssignments []models.DeviceConfigurationAssignmentable
	assignments := assignmentsResponse.GetValue()
