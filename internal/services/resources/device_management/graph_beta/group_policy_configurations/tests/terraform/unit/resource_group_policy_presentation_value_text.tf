resource "microsoft365_graph_beta_device_management_group_policy_configuration" "group_policy_presentation_value_text" {
  display_name       = "unit-test-group-policy-presentation-value-text"
  ...
  definition_values {
    ...
    presentation_values {
      ...
      presentation_id = "e23933a4-66e6-408c-82b8-f377a69c9763"
      text_value      = "example text value"
    }
  }
