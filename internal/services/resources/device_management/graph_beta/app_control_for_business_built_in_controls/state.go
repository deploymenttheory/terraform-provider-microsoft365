...
func MapRemoteResourceStateToTerraform(ctx context.Context, data *AppControlForBusinessResourceBuiltInControlsModel, remoteResource graphmodels.DeviceManagementConfigurationPolicyable) {
