...
func MapRemoteStateToTerraform(ctx context.Context, data *DeviceEnrollmentNotificationResourceModel, remoteResource graphmodels.DeviceEnrollmentConfigurationable) {
