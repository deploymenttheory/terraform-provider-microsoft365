...
func constructAssignments(ctx context.Context, data *DeviceEnrollmentNotificationResourceModel) (devicemanagement.DeviceEnrollmentConfigurationsItemAssignPostRequestBodyable, error) {
