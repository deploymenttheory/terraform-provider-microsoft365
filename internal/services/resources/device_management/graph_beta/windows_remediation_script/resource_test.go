		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.#", "1"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.type", "groupAssignmentTarget"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.group_id", "44444444-4444-4444-4444-444444444444"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.filter_id", "55555555-5555-5555-5555-555555555555"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.filter_type", "include"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.daily_schedule.interval", "1"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.daily_schedule.time", "09:00:00"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_management_windows_remediation_script.maximal", "assignments.0.daily_schedule.use_utc", "true"),
				),
			},
		},
	})
