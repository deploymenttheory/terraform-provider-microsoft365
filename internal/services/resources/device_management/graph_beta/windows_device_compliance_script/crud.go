...
func (r *DeviceComplianceScriptResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
// Read handles the Read operation for device compliance script resources.
//
...
func (r *DeviceComplianceScriptResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	respResource, err := r.client.
		DeviceManagement().
		DeviceComplianceScripts().
		ByDeviceComplianceScriptId(object.ID.ValueString()).
		Get(ctx, &devicemanagement.DeviceComplianceScriptsDeviceComplianceScriptItemRequestBuilderGetRequestConfiguration{
			QueryParameters: &devicemanagement.DeviceComplianceScriptsDeviceComplianceScriptItemRequestBuilderGetQueryParameters{
...
// Update handles the Update operation for device compliance script resources.
//
...
//
// The Microsoft Graph Beta API supports direct updates of device compliance script resources
...
func (r *DeviceComplianceScriptResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan DeviceComplianceScriptResourceModel
	var state DeviceComplianceScriptResourceModel
	...
	_, err = r.client.
		DeviceManagement().
		DeviceComplianceScripts().
		ByDeviceComplianceScriptId(state.ID.ValueString()).
...
// Delete handles the Delete operation for Device Compliance Script resources.
//
...
func (r *DeviceComplianceScriptResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var object DeviceComplianceScriptResourceModel
