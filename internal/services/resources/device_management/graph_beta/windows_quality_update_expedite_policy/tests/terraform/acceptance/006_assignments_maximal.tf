...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_006_2" {
  ...
  mail_enabled     = false
  security_enabled = true
  description      = "Test group 2 for windows quality update expedite policy assignments"
  hard_delete      = true
}
...
resource "microsoft365_graph_beta_groups_group" "acc_test_group_006_3" {
  ...
  mail_enabled     = false
  security_enabled = true
  description      = "Test group 3 for windows quality update expedite policy exclusion assignments"
  hard_delete      = true
}
