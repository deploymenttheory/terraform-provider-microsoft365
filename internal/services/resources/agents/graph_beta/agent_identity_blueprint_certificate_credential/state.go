...
func MapRemoteResourceStateToTerraform(ctx context.Context, data *AgentIdentityBlueprintCertificateCredentialResourceModel, credential graphmodels.KeyCredentialable) {
