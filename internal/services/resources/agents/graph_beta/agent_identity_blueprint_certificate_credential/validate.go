...
func validateRequest(ctx context.Context, data *AgentIdentityBlueprintCertificateCredentialResourceModel) error {
	tflog.Debug(ctx, "Starting validation of agent identity blueprint certificate credential request")
	...
	tflog.Debug(ctx, "Successfully validated agent identity blueprint certificate credential request")
	return nil
}
...
func validateCredentialStartDateIsNotInThePast(ctx context.Context, data *AgentIdentityBlueprintCertificateCredentialResourceModel) error {
...
func validateCredentialEndDateIsAfterStartDate(ctx context.Context, data *AgentIdentityBlueprintCertificateCredentialResourceModel) error {
