# Maximal Agent Identity Blueprint configuration for acceptance testing
resource "microsoft365_graph_beta_agents_agent_identity_blueprint" "test_maximal" {
  display_name = "acc-test-agent-identity-blueprint-maximal-${random_string.test_id.result}"
