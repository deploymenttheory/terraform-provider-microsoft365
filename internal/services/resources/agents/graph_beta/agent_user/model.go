// REF: https://learn.microsoft.com/en-us/graph/api/agentuser-post?view=graph-rest-beta&tabs=http
...
// AgentUserResourceModel represents the schema for the AgentUser resource
type AgentUserResourceModel struct {
	...
	IdentityParentId                types.String                 `tfsdk:"identity_parent_id"`
