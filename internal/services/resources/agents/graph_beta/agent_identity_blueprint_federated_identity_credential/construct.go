...
func constructResource(ctx context.Context, data *AgentIdentityBlueprintFederatedIdentityCredentialResourceModel) (graphmodels.FederatedIdentityCredentialable, error) {
