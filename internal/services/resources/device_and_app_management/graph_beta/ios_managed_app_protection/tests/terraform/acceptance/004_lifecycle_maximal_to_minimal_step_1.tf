resource "microsoft365_graph_beta_device_and_app_management_ios_managed_app_protection" "test_004" {
  display_name = "acc-test-ios-managed-app-protection-004-lifecycle"
