...
func constructResource(ctx context.Context, data *AndroidManagedMobileAppResourceModel) (graphmodels.ManagedMobileAppable, error) {
	...
	if data.MobileAppIdentifier != nil {
		...
		convert.FrameworkToGraphString(data.MobileAppIdentifier.PackageId, identifier.SetPackageId)
