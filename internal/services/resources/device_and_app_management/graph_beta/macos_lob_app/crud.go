...
// Create handles the complete creation workflow for a macOS LOB app resource in Intune.
//
...
//
// If a LOB app installer file is provided, the workflow continues as follows:
//
