...
// Create handles the Create operation for macOS DMG App resources.
//
// Operation: Creates a new macOS DMG application with content file upload workflow
// API Calls:
//   - POST /deviceAppManagement/mobileApps
//   - POST /deviceAppManagement/mobileApps/{mobileAppId}/microsoft.graph.macOSDmgApp/contentVersions
//   - POST /deviceAppManagement/mobileApps/{mobileAppId}/microsoft.graph.macOSDmgApp/contentVersions/{contentVersionId}/files
//   - POST /deviceAppManagement/mobileApps/{mobileAppId}/microsoft.graph.macOSDmgApp/contentVersions/{contentVersionId}/files/{fileId}/commit
//   - PATCH /deviceAppManagement/mobileApps/{mobileAppId}
//
// Reference: https://learn.microsoft.com/en-us/graph/api/intune-apps-macosdmgapp-create?view=graph-rest-beta
...
// Read handles the Read operation for macOS DMG App resources.
//
// Operation: Retrieves a macOS DMG application by ID
// API Calls:
//   - GET /deviceAppManagement/mobileApps/{mobileAppId}
//
// Reference: https://learn.microsoft.com/en-us/graph/api/intune-apps-macosdmgapp-get?view=graph-rest-beta
...
// Update handles the Update operation for macOS DMG App resources.
//
// Operation: Updates an existing macOS DMG application
// API Calls:
//   - PATCH /deviceAppManagement/mobileApps/{mobileAppId}
//
// Reference: https://learn.microsoft.com/en-us/graph/api/intune-apps-macosdmgapp-update?view=graph-rest-beta
...
// Delete handles the Delete operation for macOS DMG App resources.
//
// Operation: Deletes a macOS DMG application
// API Calls:
//   - DELETE /deviceAppManagement/mobileApps/{mobileAppId}
//
// Reference: https://learn.microsoft.com/en-us/graph/api/intune-apps-macosdmgapp-delete?view=graph-rest-beta
