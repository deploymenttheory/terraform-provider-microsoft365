...
data "microsoft365_graph_beta_device_and_app_management_mobile_app" "company_portal_004" {
...
resource "microsoft365_graph_beta_device_and_app_management_mobile_app_assignment" "test_004" {
  mobile_app_id = data.microsoft365_graph_beta_device_and_app_management_mobile_app.company_portal_004.items[0].id
