...
data "microsoft365_graph_beta_device_and_app_management_mobile_app" "company_portal_002" {
...
resource "microsoft365_graph_beta_device_and_app_management_mobile_app_assignment" "test_002" {
  mobile_app_id = data.microsoft365_graph_beta_device_and_app_management_mobile_app.company_portal_002.items[0].id
  intent        = "required"
  source        = "direct"
