...
import (
	...
	localMocks "github.com/deploymenttheory/terraform-provider-microsoft365/internal/services/resources/device_and_app_management/graph_beta/windows_managed_mobile_app/mocks"
...
func testConfigError() string {
	...
	return `
resource "microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app" "error" {
...
func setupMockEnvironment() (*mocks.Mocks, *localMocks.WindowsManagedMobileAppMock) {
	// Activate httpmock
	httpmock.Activate()
	...
	managedAppMock := &localMocks.WindowsManagedMobileAppMock{}
...
func testConfigMinimalWithResourceName(resourceName string) string {
	return fmt.Sprintf(`resource "microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app" "%s" {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckExists("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal", "managed_app_protection_id", "00000000-0000-0000-0000-000000000002"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal", "mobile_app_identifier.windows_app_id", "com.example.testapp"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckExists("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.maximal"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.maximal", "managed_app_protection_id", "00000000-0000-0000-0000-000000000003"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.maximal", "mobile_app_identifier.windows_app_id", "com.example.complexapp"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.maximal", "version", "1.5"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			// Update to maximal configuration (with the same resource name)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckExists("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal", "managed_app_protection_id", "00000000-0000-0000-0000-000000000002"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal", "mobile_app_identifier.windows_app_id", "com.example.complexapp"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal", "version", "1.5"),
				),
			},
		},
	})
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Start with maximal configuration
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckExists("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.test"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.test", "version", "1.5"),
				),
			},
			// Update to minimal configuration (with the same resource name)
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckExists("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.test"),
					resource.TestCheckResourceAttr("microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.test", "mobile_app_identifier.windows_app_id", "com.example.testapp"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			// Delete the resource (by providing empty config)
			{
				...
				Check: func(s *terraform.State) error {
					...
					_, exists := s.RootModule().Resources["microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.minimal"]
					if exists {
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// Delete the resource (by providing empty config)
			{
				...
				Check: func(s *terraform.State) error {
					// The resource should be gone
					_, exists := s.RootModule().Resources["microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.maximal"]
					if exists {
						return fmt.Errorf("resource still exists after deletion")
					}
					return nil
...
func TestUnitResourceWindowsManagedMobileApp_07_Import(t *testing.T) {
	...
	importConfig := `
resource "microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app" "import_test" {
...
`
	...
	resource.UnitTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config:        importConfig,
				ResourceName:  "microsoft365_graph_beta_device_and_app_management_windows_managed_mobile_app.import_test",
				ImportState:   true,
		...
		Steps: []resource.TestStep{
			{
				...
				ExpectError: regexp.MustCompile("Error creating Windows managed mobile app"),
			},
		},
	})
}
