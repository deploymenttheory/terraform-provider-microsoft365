...
func constructResource(ctx context.Context, data *WindowsManagedMobileAppResourceModel) (graphmodels.ManagedMobileAppable, error) {
	...
	if data.MobileAppIdentifier != nil {
		...
		convert.FrameworkToGraphString(data.MobileAppIdentifier.WindowsAppId, identifier.SetWindowsAppId)
