resource "microsoft365_graph_beta_device_and_app_management_android_managed_app_protection" "test_003" {
  display_name = "acc-test-android-managed-app-protection-003-lifecycle"
