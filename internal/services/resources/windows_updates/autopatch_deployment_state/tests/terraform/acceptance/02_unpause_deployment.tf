...
resource "microsoft365_graph_beta_windows_updates_autopatch_deployment" "base" {
  content = {
...
resource "microsoft365_graph_beta_windows_updates_autopatch_deployment_state" "test" {
  deployment_id   = microsoft365_graph_beta_windows_updates_autopatch_deployment.base.id
