...
type WindowsUpdatesAutopatchRingResourceModel struct {
	...
	IncludedGroupAssignment *GroupAssignmentModel  `tfsdk:"included_group_assignment"`
	ExcludedGroupAssignment *GroupAssignmentModel  `tfsdk:"excluded_group_assignment"`
