...
func constructCreateRequest(ctx context.Context, plan *WindowsUpdatesAutopatchDeploymentAudienceMembersResourceModel) (graphadmin.WindowsUpdatesDeploymentAudiencesItemMicrosoftGraphWindowsUpdatesUpdateAudienceUpdateAudiencePostRequestBodyable, error) {
...
func constructUpdateRequest(ctx context.Context, plan *WindowsUpdatesAutopatchDeploymentAudienceMembersResourceModel, state *WindowsUpdatesAutopatchDeploymentAudienceMembersResourceModel) (graphadmin.WindowsUpdatesDeploymentAudiencesItemMicrosoftGraphWindowsUpdatesUpdateAudienceUpdateAudiencePostRequestBodyable, error) {
...
func constructDeleteRequest(ctx context.Context, state *WindowsUpdatesAutopatchDeploymentAudienceMembersResourceModel) (graphadmin.WindowsUpdatesDeploymentAudiencesItemMicrosoftGraphWindowsUpdatesUpdateAudienceUpdateAudiencePostRequestBodyable, error) {
