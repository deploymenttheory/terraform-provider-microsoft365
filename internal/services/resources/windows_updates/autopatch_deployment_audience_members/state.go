...
func MapRemoteStateToTerraform(ctx context.Context, data *WindowsUpdatesAutopatchDeploymentAudienceMembersResourceModel, members []graphmodelswindowsupdates.UpdatableAssetable, exclusions []graphmodelswindowsupdates.UpdatableAssetable) {
