...
func MapRemoteStateToTerraform(ctx context.Context, data *WindowsUpdatesAutopatchContentApprovalResourceModel, remoteResource graphmodelswindowsupdates.ComplianceChangeable) {
