resource "microsoft365_graph_beta_users_user" "maximal" {
  ...
  user_principal_name = "maximal.user@deploymenttheory.com"
  ...
  identities = [
    {
      ...
      issuer_assigned_id = "maximal.user@deploymenttheory.com"
    }
  ]
  other_mails          = ["maximal.user.other@deploymenttheory.com"]
