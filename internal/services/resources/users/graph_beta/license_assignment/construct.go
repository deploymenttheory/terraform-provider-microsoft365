...
func constructAddLicensesRequest(ctx context.Context, data *UserLicenseAssignmentResourceModel) (users.ItemAssignLicensePostRequestBodyable, error) {
...
func constructUpdateLicenseRequest(ctx context.Context, data *UserLicenseAssignmentResourceModel) (users.ItemAssignLicensePostRequestBodyable, error) {
...
func constructRemoveLicenseRequest(ctx context.Context, skuId string) (users.ItemAssignLicensePostRequestBodyable, error) {
