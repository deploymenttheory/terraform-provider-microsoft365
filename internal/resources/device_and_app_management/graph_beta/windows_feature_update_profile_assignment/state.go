...
func MapRemoteResourceStateToTerraform(ctx context.Context, data *WindowsFeatureUpdateProfileAssignmentResourceModel, assignments []graphmodels.WindowsFeatureUpdateProfileAssignmentable) {
