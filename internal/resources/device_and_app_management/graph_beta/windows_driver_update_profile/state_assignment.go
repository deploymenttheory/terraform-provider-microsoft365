...
func MapRemoteAssignmentsToTerraform(ctx context.Context, data *WindowsDriverUpdateProfileResourceModel, assignments []graphmodels.WindowsDriverUpdateProfileAssignmentable) {
