...
func MapRemoteAssignmentStateToTerraform(ctx context.Context, data *DeviceManagementTemplateResourceModel, assignmentsResponse models.DeviceManagementConfigurationPolicyAssignmentCollectionResponseable) {
