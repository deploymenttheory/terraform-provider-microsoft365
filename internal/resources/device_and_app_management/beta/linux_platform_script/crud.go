...
// 	object LinuxPlatformScriptResourceModel
// )

// // Create handles the Create operation for Linux Platform Script Settings Catalog resources.
// //
...
// func (r *LinuxPlatformScriptResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
...
// // Read handles the Read operation for Linux Platform Script Settings Catalog resources.
// //
...
// // Update handles the Update operation for Linux Platform Script Settings Catalog resources.
// //
...
// // Delete handles the Delete operation for Linux Platform Script Settings Catalog resources.
// //
...
// func (r *LinuxPlatformScriptResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
