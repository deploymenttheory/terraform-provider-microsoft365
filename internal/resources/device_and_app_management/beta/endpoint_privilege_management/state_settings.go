...
func MapRemoteSettingsStateToTerraform(ctx context.Context, data *EndpointPrivilegeManagementResourceModel, remoteSettings []graphmodels.DeviceManagementConfigurationSettingable) {
