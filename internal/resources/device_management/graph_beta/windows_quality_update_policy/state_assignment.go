...
func MapRemoteAssignmentsToTerraform(ctx context.Context, data *WindowsQualityUpdatePolicyResourceModel, assignments []graphmodels.WindowsQualityUpdatePolicyAssignmentable) {
