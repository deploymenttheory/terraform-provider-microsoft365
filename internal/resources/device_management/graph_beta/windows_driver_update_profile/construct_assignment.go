...
func constructAssignments(ctx context.Context, data *WindowsDriverUpdateProfileResourceModel) (devicemanagement.WindowsDriverUpdateProfilesItemAssignPostRequestBodyable, error) {
