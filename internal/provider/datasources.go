...
import (
	...
	graphBetaDeviceAndAppManagementWindowsQualityUpdateProfile "github.com/deploymenttheory/terraform-provider-microsoft365/internal/datasources/device_and_app_management/graph_beta/windows_quality_update_profile"
...
func (p *M365Provider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		graphBetaDeviceAndAppManagementWindowsQualityUpdateProfile.NewWindowsQualityUpdateProfileDataSource,
