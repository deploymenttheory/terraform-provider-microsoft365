...
- `description` (String) The description of the resource. Maximum length is 1500 characters. This field is automatically populated based on the package identifier when `automatically_generate_metadata` is set to true.
