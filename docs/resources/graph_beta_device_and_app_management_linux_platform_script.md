...
# microsoft365_graph_beta_device_and_app_management_linux_platform_script (Resource)
...
# {resource_id}
terraform import microsoft365_graph_beta_device_and_app_management_linux_platform_script.example linux-platform-script-id
```
