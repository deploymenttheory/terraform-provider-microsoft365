---
page_title: "microsoft365_graph_beta_device_management_settings_catalog_json Resource - terraform-provider-microsoft365"
subcategory: "Intune"
description: |-
  Manages a Settings Catalog policy in Microsoft Intune for Windows, macOS, iOS/iPadOS and Android.
---

# microsoft365_graph_beta_device_management_settings_catalog_json (Resource)
...
```terraform
resource "microsoft365_graph_beta_device_management_settings_catalog_json" "test_macOS" {
...
```shell
# {resource_id}
terraform import microsoft365_graph_beta_device_and_app_management_settings_catalog_json.example settings-catalog-id
```
