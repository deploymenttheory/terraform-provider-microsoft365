...
# Replace {assignment_id} with the actual app role assignment ID from your Microsoft 365 tenant

# Import a group app role assignment
terraform import microsoft365_graph_beta_groups_group_app_role_assignment.example {assignment_id}

# Import a read-only app role assignment
terraform import microsoft365_graph_beta_groups_group_app_role_assignment.read_only {assignment_id}

# Import a full-access app role assignment
terraform import microsoft365_graph_beta_groups_group_app_role_assignment.full_access {assignment_id}
