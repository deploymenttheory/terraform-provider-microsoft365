...
- `include_user_actions` (Set of String) User actions to include in the policy. Valid values are: urn:user:registersecurityinfo, urn:user:registerdevice, urn:user:accountrecovery.
...
- `built_in_controls` (Set of String) List of built-in controls required by the policy. Possible values are: block, mfa, compliantDevice, domainJoinedDevice, approvedApplication, compliantApplication, passwordChange, riskRemediation, verifiedID.
