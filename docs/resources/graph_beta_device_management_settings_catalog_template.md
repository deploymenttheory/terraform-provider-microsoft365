---
page_title: "microsoft365_graph_beta_device_management_settings_catalog_template Resource - terraform-provider-microsoft365"
subcategory: "Intune"
description: |-
  Manages a Settings Catalog policy template in Microsoft Intune for Windows, macOS, Linux, iOS/iPadOS and Android.
---

# microsoft365_graph_beta_device_management_settings_catalog_template (Resource)
