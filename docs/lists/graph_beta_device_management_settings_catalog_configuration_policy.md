...
description: |-
  Lists Settings Catalog configuration policies from Microsoft Intune. Supports filtering by name, platform, template family, assignment status, and custom OData queries.
---
