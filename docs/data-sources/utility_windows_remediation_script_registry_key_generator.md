...
description: |-
  Generates PowerShell detection and remediation scripts locally for Intune Proactive Remediations. This data source is used to create standardized registry key management scripts with proper error handling and exit codes.
---
