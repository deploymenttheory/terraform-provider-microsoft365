---
page_title: "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item Data Source - terraform-provider-microsoft365"
...
# microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item (Data Source)
...
data "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item" "all" {
  filter_type = "all"
}
...
output "all_windows_updates" {
  ...
  value = [
    for item in data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.all.items : {
      id                  = item.id
...
# Filter by ID
data "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item" "by_id" {
  filter_type  = "id"
...
output "specific_update" {
  ...
  value = length(data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_id.items) > 0 ? {
    id                  = data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_id.items[0].id
    display_name        = data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_id.items[0].display_name
    release_date_time   = data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_id.items[0].release_date_time
    end_of_support_date = data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_id.items[0].end_of_support_date
  } : null
}

# Filter by display name (will return all items containing "Security Update" in their name)
data "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item" "by_name" {
...
output "updates_by_name" {
  ...
  value = [
    for item in data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_name.items : {
      id                  = item.id
      display_name        = item.display_name
      release_date_time   = item.release_date_time
      end_of_support_date = item.end_of_support_date
...
data "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item" "by_release_date" {
...
output "updates_by_release_date" {
  ...
  value = [
    for item in data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_release_date.items : {
      id                  = item.id
      display_name        = item.display_name
      release_date_time   = item.release_date_time
      end_of_support_date = item.end_of_support_date
...
data "microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item" "by_end_of_support" {
...
output "updates_by_end_of_support" {
  ...
  value = [
    for item in data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_end_of_support.items : {
      id                  = item.id
      display_name        = item.display_name
      release_date_time   = item.release_date_time
      end_of_support_date = item.end_of_support_date
...
output "end_of_support_count" {
  ...
  value       = length(data.microsoft365_graph_beta_device_management_windows_update_catalog_enteries_item.by_end_of_support.items)
}
```
